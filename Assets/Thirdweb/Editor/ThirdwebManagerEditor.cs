...
namespace Thirdweb
{
    ...
    public class ThirdwebManagerEditor : Editor
    {
        ...
        private static readonly string ExpandedStateKey = "ThirdwebManagerEditor_ExpandedState_4.12.2";
        private static readonly string OptionalStateKey = "ThirdwebManagerEditor_OptionalState_4.12.2";
