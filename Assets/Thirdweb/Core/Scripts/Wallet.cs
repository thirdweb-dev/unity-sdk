...
namespace Thirdweb
{
    ...
    public class AuthOptions
    {
        ...
        /// <param name="encryptionKey">Custom Auth Only: The encryption key to use for the recovery share.</param>
        /// <returns>A new instance of the <see cref="AuthOptions"/> class.</returns>
        public AuthOptions(AuthProvider authProvider, string authToken = null, string encryptionKey = null)
        {
