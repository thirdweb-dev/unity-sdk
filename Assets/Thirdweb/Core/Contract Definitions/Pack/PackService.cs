...
namespace Thirdweb.Contracts.Pack
{
    public partial class PackService
    {
        ...
        public Task<TransactionReceipt> AddPackContentsRequestAndWaitForReceiptAsync(BigInteger packId, List<Token> contents, List<BigInteger> numOfRewardUnits, string recipient, CancellationTokenSource cancellationToken = null)
        {
            var addPackContentsFunction = new AddPackContentsFunction();
            addPackContentsFunction.PackId = packId;
            addPackContentsFunction.Contents = contents;
        ...
        public Task<string> CreatePackRequestAsync(List<Token> contents, List<BigInteger> numOfRewardUnits, string packUri, BigInteger openStartTimestamp, BigInteger amountDistributedPerOpen, string recipient)
        {
        ...
        public Task<TransactionReceipt> CreatePackRequestAndWaitForReceiptAsync(List<Token> contents, List<BigInteger> numOfRewardUnits, string packUri, BigInteger openStartTimestamp, BigInteger amountDistributedPerOpen, string recipient, CancellationTokenSource cancellationToken = null)
        {
            var createPackFunction = new CreatePackFunction();
            createPackFunction.Contents = contents;
            createPackFunction.NumOfRewardUnits = numOfRewardUnits;
        ...
        public Task<TransactionReceipt> InitializeRequestAndWaitForReceiptAsync(string defaultAdmin, string name, string symbol, string contractURI, List<string> trustedForwarders, string royaltyRecipient, BigInteger royaltyBps, CancellationTokenSource cancellationToken = null)
        {
            var initializeFunction = new InitializeFunction();
            initializeFunction.DefaultAdmin = defaultAdmin;
            initializeFunction.Name = name;
