...
namespace Thirdweb.Contracts.DropERC721
{
    public partial class DropERC721Service
    {
        ...
        public Task<byte[]> EncryptDecryptQueryAsync(
            EncryptDecryptFunction encryptDecryptFunction,
            BlockParameter blockParameter = null
        )
        {
        ...
        public Task<byte[]> EncryptedDataQueryAsync(
            EncryptedDataFunction encryptedDataFunction,
            BlockParameter blockParameter = null
        )
        {
        ...
        public Task<string> GetApprovedQueryAsync(
            GetApprovedFunction getApprovedFunction,
            BlockParameter blockParameter = null
        )
        {
        ...
        public Task<string> GetRevealURIQueryAsync(
            GetRevealURIFunction getRevealURIFunction,
            BlockParameter blockParameter = null
        )
        {
        ...
        {
            return ContractHandler.QueryAsync<NextTokenIdToClaimFunction, BigInteger>(
                nextTokenIdToClaimFunction,
                blockParameter
            );
        }
        ...
        public Task<BigInteger> TotalMintedQueryAsync(
            TotalMintedFunction totalMintedFunction,
            BlockParameter blockParameter = null
        )
        {
