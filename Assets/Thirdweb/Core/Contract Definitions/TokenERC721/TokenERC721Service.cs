...
namespace Thirdweb.Contracts.TokenERC721
{
    ...
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, TokenERC721Deployment tokenERC721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static async Task<TokenERC721Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, TokenERC721Deployment tokenERC721Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
