...
namespace Thirdweb.Contracts.DropERC1155
{
    ...
    {
        public static Task<TransactionReceipt> DeployContractAndWaitForReceiptAsync(Nethereum.Web3.Web3 web3, DropERC1155Deployment dropERC1155Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public static async Task<DropERC1155Service> DeployContractAndGetServiceAsync(Nethereum.Web3.Web3 web3, DropERC1155Deployment dropERC1155Deployment, CancellationTokenSource cancellationTokenSource = null)
        {
        ...
        public Task<TransactionReceipt> ClaimRequestAndWaitForReceiptAsync(string receiver, BigInteger tokenId, BigInteger quantity, string currency, BigInteger pricePerToken, AllowlistProof allowlistProof, byte[] data, CancellationTokenSource cancellationToken = null)
        {
            var claimFunction = new ClaimFunction();
            claimFunction.Receiver = receiver;
            claimFunction.TokenId = tokenId;
        ...
        public Task<string> InitializeRequestAsync(string defaultAdmin, string name, string symbol, string contractURI, List<string> trustedForwarders, string saleRecipient, string royaltyRecipient, BigInteger royaltyBps, BigInteger platformFeeBps, string platformFeeRecipient)
        {
        ...
        public Task<TransactionReceipt> InitializeRequestAndWaitForReceiptAsync(string defaultAdmin, string name, string symbol, string contractURI, List<string> trustedForwarders, string saleRecipient, string royaltyRecipient, BigInteger royaltyBps, BigInteger platformFeeBps, string platformFeeRecipient, CancellationTokenSource cancellationToken = null)
        {
            var initializeFunction = new InitializeFunction();
            initializeFunction.DefaultAdmin = defaultAdmin;
            initializeFunction.Name = name;
        ...
        public Task<TransactionReceipt> SetClaimConditionsRequestAndWaitForReceiptAsync(BigInteger tokenId, List<ClaimCondition> conditions, bool resetClaimEligibility, CancellationTokenSource cancellationToken = null)
        {
            var setClaimConditionsFunction = new SetClaimConditionsFunction();
            setClaimConditionsFunction.TokenId = tokenId;
            setClaimConditionsFunction.Conditions = conditions;
        ...
        public Task<TransactionReceipt> SetDefaultRoyaltyInfoRequestAndWaitForReceiptAsync(SetDefaultRoyaltyInfoFunction setDefaultRoyaltyInfoFunction, CancellationTokenSource cancellationToken = null)
        {
        ...
        public Task<TransactionReceipt> SetOperatorRestrictionRequestAndWaitForReceiptAsync(SetOperatorRestrictionFunction setOperatorRestrictionFunction, CancellationTokenSource cancellationToken = null)
        {
        ...
        public Task<TransactionReceipt> SetPrimarySaleRecipientRequestAndWaitForReceiptAsync(SetPrimarySaleRecipientFunction setPrimarySaleRecipientFunction, CancellationTokenSource cancellationToken = null)
        {
        ...
        public Task<TransactionReceipt> SetRoyaltyInfoForTokenRequestAndWaitForReceiptAsync(SetRoyaltyInfoForTokenFunction setRoyaltyInfoForTokenFunction, CancellationTokenSource cancellationToken = null)
        {
        ...
        public Task<TransactionReceipt> SetSaleRecipientForTokenRequestAndWaitForReceiptAsync(SetSaleRecipientForTokenFunction setSaleRecipientForTokenFunction, CancellationTokenSource cancellationToken = null)
        {
        ...
        public Task<bool> VerifyClaimQueryAsync(BigInteger conditionId, string claimer, BigInteger tokenId, BigInteger quantity, string currency, BigInteger pricePerToken, AllowlistProof allowlistProof, BlockParameter blockParameter = null)
        {
